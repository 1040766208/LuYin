  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        middle: Text(widget.detail['songname'].toString()),//歌曲名称
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
              child: Text("歌曲总时长:"+widget.detail['interval'].toString(),
              style:TextStyle(
                color: Colors.black,
                fontSize: 15.0,
      ...
      await http.post(
        ...
        if (response.statusCode.toString() == '200') {
          setState(() {
            ...
            _musicResourcesUrl = data['data'][widget.detail['songmid']].replaceAll('http://122.226.161.16','https://ws.stream.qqmusic.qq.com/');//歌曲链接替换
